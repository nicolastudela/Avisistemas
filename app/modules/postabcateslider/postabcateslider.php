...
class postabcateslider extends Module {
	...
	{	
		...
		$values['postabcateslider_title'][(int)$id_lang] = '';
      ...
      public function uninstall() {
        ...
        Configuration::updateValue($this->name . '_per_xs');
	...
	public function hookblockPosition1($params) {
			...
			$product_on_row = Configuration::get($this->name . '_row');
		    $arrayCategory = array();
			...
			foreach($cateArray as $id_category) {
				...
				$categoryProducts = $category->getProducts($this->context->language->id, 1, ($nb ? $nb : 8), $sortby , $orderby ,false,true,$random,($nb ? $nb : 8));
