...
class PosSpecialProducts extends Module {
	...
	{	
		...
		$values['posspecialproducts_title'][(int)$id_lang] = 'Specials products';
	...
	public function hookblockPosition1($params) {
			...
			if (!$this->isCached('posspecialproducts.tpl', $this->getCacheId())) {
				PosSpecialProducts::$cache_specials = Product::getPricesDrop((int) Context::getContext()->language->id, 0, ($nb ? $nb : 8), false,  $sortby , $orderby);
	            ...
	            $this->smarty->assign(array(
					'products' => PosSpecialProducts::$cache_specials,
        ...
        if (PosSpecialProducts::$cache_specials === false)
				return false;
        
		return $this->display(__FILE__, 'posspecialproducts.tpl', $this->getCacheId());
	}
