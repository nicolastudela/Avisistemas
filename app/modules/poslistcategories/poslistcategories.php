...
class PosListCategories extends Module
{
	protected $_html = '';
	...
	public function hookblockPosition1($params)
	{
		...
		$id_lang = $this->context->language->id;
		 ...
		 $configure = array(
			 ...
			 'item_md' => $config[$this->name.'_per_md'],
			 'item_sm' => $config[$this->name.'_per_sm'],
			 'item_xs' => $config[$this->name.'_per_xs'],
			 'item_xxs' => $config[$this->name.'_per_xxs'],
		 );
		...
		return $this->display(__FILE__, 'poslistcategories.tpl', $this->getCacheId());
	}
