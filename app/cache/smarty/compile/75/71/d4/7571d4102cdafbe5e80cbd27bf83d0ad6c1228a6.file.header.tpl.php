<?php /* Smarty version Smarty-3.1.19, created on 2017-07-16 20:58:23
         compiled from "/Users/nicotudela/work/workspace/avisistemas/app/themes/pos_haxico4/header.tpl" */ ?>
<?php /*%%SmartyHeaderCode:508003791596bfd9f539274-65438515%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '7571d4102cdafbe5e80cbd27bf83d0ad6c1228a6' => 
    array (
      0 => '/Users/nicotudela/work/workspace/avisistemas/app/themes/pos_haxico4/header.tpl',
      1 => 1498952572,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '508003791596bfd9f539274-65438515',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_596bfd9f690893_75593651',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_596bfd9f690893_75593651')) {function content_596bfd9f690893_75593651($_smarty_tpl) {?><?php if (!is_callable('smarty_function_implode')) include '/Users/nicotudela/work/workspace/avisistemas/app/tools/smarty/plugins/function.implode.php';
?>
<!DOCTYPE HTML>
...
material-design-iconic-font.min.css" type="text/css" />
		<link rel="stylesheet" href="<?php echo $_smarty_tpl->tpl_vars['css_dir']->value;?>
...
<?php if (isset($_smarty_tpl->tpl_vars['geolocation_country']->value)&&$_smarty_tpl->tpl_vars['geolocation_country']->value) {?> <span class="bold"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['geolocation_country']->value, ENT_QUOTES, 'UTF-8', true);?>
		...
		<?php }?>
		<div id="page"<?php if ($_smarty_tpl->tpl_vars['page_name']->value!="index") {?> class="sub-page"<?php }?>>
							...
							<div class="container-inner">
								<div class="row">
									<div class="col-md-3 col-sm-3 col-xs-12">
										<?php $_smarty_tpl->_capture_stack[0][] = array('vegamenu', null, null); ob_start(); ?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['hook'][0][0]->smartyHook(array('h'=>'vegamenu'),$_smarty_tpl);?>
<?php list($_capture_buffer, $_capture_assign, $_capture_append) = array_pop($_smarty_tpl->_capture_stack[0]);
if (!empty($_capture_buffer)) {
 if (isset($_capture_assign)) $_smarty_tpl->assign($_capture_assign, ob_get_contents());
 if (isset( $_capture_append)) $_smarty_tpl->append( $_capture_append, ob_get_contents());
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
										...
										<?php if (Smarty::$_smarty_vars['capture']['vegamenu']) {?>
										<?php echo Smarty::$_smarty_vars['capture']['vegamenu'];?>

										<?php }?>
									</div>
									<div class="col-md-9 col-sm-12 col-xs-12">
										<?php $_smarty_tpl->_capture_stack[0][] = array('megamenu', null, null); ob_start(); ?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['hook'][0][0]->smartyHook(array('h'=>'megamenu'),$_smarty_tpl);?>
<?php list($_capture_buffer, $_capture_assign, $_capture_append) = array_pop($_smarty_tpl->_capture_stack[0]);
if (!empty($_capture_buffer)) {
 if (isset($_capture_assign)) $_smarty_tpl->assign($_capture_assign, ob_get_contents());
 if (isset( $_capture_append)) $_smarty_tpl->append( $_capture_append, ob_get_contents());
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
										...
										<?php if (Smarty::$_smarty_vars['capture']['megamenu']) {?>
										<?php echo Smarty::$_smarty_vars['capture']['megamenu'];?>
				...
				<?php if ($_smarty_tpl->tpl_vars['page_name']->value=="index") {?>
					<div class=" pos_bannerslide">
						<div class="container">
							<?php $_smarty_tpl->_capture_stack[0][] = array('bannerSlide', null, null); ob_start(); ?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['hook'][0][0]->smartyHook(array('h'=>'bannerSlide'),$_smarty_tpl);?>
<?php list($_capture_buffer, $_capture_assign, $_capture_append) = array_pop($_smarty_tpl->_capture_stack[0]);
if (!empty($_capture_buffer)) {
 if (isset($_capture_assign)) $_smarty_tpl->assign($_capture_assign, ob_get_contents());
 if (isset( $_capture_append)) $_smarty_tpl->append( $_capture_append, ob_get_contents());
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
							...
							<?php if (Smarty::$_smarty_vars['capture']['bannerSlide']) {?>
							<?php echo Smarty::$_smarty_vars['capture']['bannerSlide'];?>

							<?php }?>	
						</div>
					</div>
					<?php $_smarty_tpl->_capture_stack[0][] = array('blockPosition1', null, null); ob_start(); ?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['hook'][0][0]->smartyHook(array('h'=>'blockPosition1'),$_smarty_tpl);?>
<?php list($_capture_buffer, $_capture_assign, $_capture_append) = array_pop($_smarty_tpl->_capture_stack[0]);
if (!empty($_capture_buffer)) {
 if (isset($_capture_assign)) $_smarty_tpl->assign($_capture_assign, ob_get_contents());
 if (isset( $_capture_append)) $_smarty_tpl->append( $_capture_append, ob_get_contents());
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
					...
					<?php if (Smarty::$_smarty_vars['capture']['blockPosition1']) {?>
					<?php echo Smarty::$_smarty_vars['capture']['blockPosition1'];?>

					<?php }?>
					<div class="container">
						<div class="row">
						<?php $_smarty_tpl->_capture_stack[0][] = array('blockPosition2', null, null); ob_start(); ?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['hook'][0][0]->smartyHook(array('h'=>'blockPosition2'),$_smarty_tpl);?>
<?php list($_capture_buffer, $_capture_assign, $_capture_append) = array_pop($_smarty_tpl->_capture_stack[0]);
if (!empty($_capture_buffer)) {
 if (isset($_capture_assign)) $_smarty_tpl->assign($_capture_assign, ob_get_contents());
 if (isset( $_capture_append)) $_smarty_tpl->append( $_capture_append, ob_get_contents());
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
						...
						<?php if (Smarty::$_smarty_vars['capture']['blockPosition2']) {?>
						<?php echo Smarty::$_smarty_vars['capture']['blockPosition2'];?>
