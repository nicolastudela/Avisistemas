...
<div class="pos_featured_product block_product">
	<div class="container-inner">
		<div class=" row">
			<div class="featured_product col-sm-12 col-md-6 col-xs-12">
				{if $title}
				<div class="pos-title">
					<h2>{$title}</h2>
				</div>
											...
											<div class="actions-inner">
												<div class="cart">
													...
													{if isset($static_token)}
														<a class="button ajax_add_to_cart_button btn btn-default" href="{$link->getPageLink('cart',false, NULL, "add=1&amp;id_product={$product.id_product|intval}&amp;token={$static_token}", false)|escape:'html':'UTF-8'}" rel="nofollow"  title="{l s='Add to cart' mod='posfeaturedproducts'}" data-id-product="{$product.id_product|intval}">
															<span>{l s='Add to cart' mod='posfeaturedproducts'}</span>
															
														</a>
													{else}
													<a class="button ajax_add_to_cart_button btn btn-default" href="{$link->getPageLink('cart',false, NULL, 'add=1&amp;id_product={$product.id_product|intval}', false)|escape:'html':'UTF-8'}" rel="nofollow" title="{l s='Add to cart' mod='posfeaturedproducts'}" data-id-product="{$product.id_product|intval}">
														<span>{l s='Add to cart' mod='posfeaturedproducts'}</span>
													</a>
													   {/if}      
													{else}
